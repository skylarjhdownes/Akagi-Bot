  ...
  if (message.content.substring(0, 1) in ["!","/"])
    ...
    if(commandArgs[0] == "help")
      if(commandArgs.length == 1)
        ...
        message.channel.send("Type '!help X' where X is the command you want to learn about.  The general commands are: roll, throw, mahjong, english, value, and tiles.")
      ...
      else if(commandArgs[1] == "throw")
        message.channel.send("Syntax: throw <rock || paper || scissors>
                              Used to play rock paper scissors.")
